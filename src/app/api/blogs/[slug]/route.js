...
export function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        ...
        return __generator(this, function (_c) {
            slug = params.slug;
            console.log("Fetching blog with slug: ".concat(slug));
            return [2 /*return*/, blogController.getBySlug(slug)];
        });
    });
}
export function PUT(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var params = _b.params;
        return __generator(this, function (_c) {
            console.log("Updating blog with slug: ".concat(params.slug));
            ...
            return [2 /*return*/, blogController.update(parseInt(params.slug, 10), request)];
        });
    });
}
export function DELETE(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var params = _b.params;
        return __generator(this, function (_c) {
            console.log("Deleting blog with slug: ".concat(params.slug));
            // Assuming delete still uses ID, we'll need to adjust this if the user wants to delete by slug
            // For now, this will fail if a slug is passed.
            return [2 /*return*/, blogController.delete(parseInt(params.slug, 10))];
        });
    });
}
