...
export function GET(request_1, _a) {
    return __awaiter(this, arguments, void 0, function (request, _b) {
        var slug, connection, query, rows, error_1;
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    slug = params.slug;
                    if (!slug) {
                        return [2 /*return*/, NextResponse.json({ success: false, error: "Post slug is required." }, { status: 400 })];
                    }
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 5, , 6]);
                ...
                case 4:
                    _c.sent();
                    if (rows.length === 0) {
                        return [2 /*return*/, NextResponse.json({ success: false, error: "Post not found." }, { status: 404 })];
                    }
                    return [2 /*return*/, NextResponse.json({ success: true, data: rows[0] })];
                case 5:
                    error_1 = _c.sent();
                    console.error("DATABASE ERROR for slug ".concat(slug, ":"), error_1);
                    return [2 /*return*/, NextResponse.json({ success: false, error: "Internal Server Error." }, { status: 500 })];
