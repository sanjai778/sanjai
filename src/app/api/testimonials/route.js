...
export function GET() {
    return __awaiter(this, void 0, void 0, function () {
        var testimonialService, testimonials, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    testimonialService = new TestimonialService();
                    return [4 /*yield*/, testimonialService.getAll()];
                case 1:
                    testimonials = _a.sent();
                    if (!testimonials || testimonials.length === 0) {
                        return [2 /*return*/, NextResponse.json({ message: "No testimonials found" }, { status: 404 })];
                    }
